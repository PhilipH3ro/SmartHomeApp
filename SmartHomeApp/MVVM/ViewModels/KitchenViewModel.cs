...
{
    internal class KitchenViewModel : ViewHelper
    {
        ...
        private async void Timer_Tick_Temperature(object sender, EventArgs e)
        {
            ...
            //var randomTemperature = new Random();
            //CurrentTemperature = randomTemperature.Next(15, 22).ToString();s
        }
        ...
        private async Task StartDevicesAsync()
        {
            ...
            var result = registryManager.CreateQuery("select * from devices where properties.reported.location = 'kitchen' or properties.reported.location = 'Kitchen'");
