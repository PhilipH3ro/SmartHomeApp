...
using Device.Livingroom.Tv1.Models;
using Newtonsoft.Json;
using System.Text;

namespace Device.Livingroom.Tv1
{
    public partial class MainWindow : Window
    {
        private readonly string _connect_url = "http://localhost:7289/api/devices/connect";
        private readonly string _connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\PhilipHero\\source\\repos\\SmartHomeApp\\Device.Livingroom.Tv1\\Data\\DB_Livingroom_Tv1.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        private async Task SetupAsync()
        {
            ...
            if (string.IsNullOrEmpty(_deviceId))
            {
                ...
                await conn.ExecuteAsync("INSERT INTO DeviceInfo (DeviceId,DeviceName,DeviceType,Location) VALUES (@DeviceId, @DeviceName, @DeviceType, @Location)", new { DeviceId = _deviceId, DeviceName = "Tv", DeviceType = "tv", Location = "livingroom" });
            }
